...
public class CrimsonForgeMenu extends AbstractContainerMenu {
    ...
    public CrimsonForgeMenu(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data) {
        super(ModMenuTypes.CRIMSON_FORGE_MENU.get(), pContainerId);
        checkContainerSize(inv, 5);
        blockEntity = ((CrimsonForgeBlockEntity) entity);
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                pPlayer, ModBlocks.CRIMSON_FORGE.get());
    }
